...
break
 ...
 y1=e.target.id[1]*1
 x1=xarr.indexOf(e.target.id[0])*1+1
 if(e.target.id[3] == 'w'){if(y1 == 2) {if(arr[8-y1-2][x1-1].id[3] == undefined) {hClv.push(arr[8-y1-2][x1-1].id)}}
if(x1 != 1) {if(arr[8-y1*1-1][x1*1-2].id[3] == 'b') {hClv.push(arr[8-y1*1-1][x1*1-2].id)}}
 

 if(x1 != 8){ if(arr[8-y1*1-1][x1*1].id[3] == 'b' ) {hClv.push(arr[8-y1*1-1][x1*1].id)}}  
 ...
 if(e.target.id[3] == 'b'){if(y1 == 7 ){ if(arr[8-y1+2][x1-1].id[3] == undefined) {hClv.push(arr[8-y1+2][x1-1].id)}}

 if(x1 != 1){if(arr[8-y1*1+1][x1*1-2].id[3] == 'w') {hClv.push(arr[8-y1*1+1][x1*1-2].id)}}
 

if(x1 != 8 ){ if(arr[8-y1*1+1][x1*1].id[3] == 'w' ) {hClv.push(arr[8-y1*1+1][x1*1].id)}}
