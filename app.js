...
if(x2 != -1 & y2 != -1 )
   ...
   if(hClv.length != 0) {arr[8 - e.target.id[1]][xarr.indexOf(e.target.id[0])].style.outline = '0.4vw solid green'}else{arr[8 - e.target.id[1]][xarr.indexOf(e.target.id[0])].style.outline = '0.4vw solid red'}
    y2 = 8-e.target.id[1]
    x2 = xarr.indexOf(e.target.id[0])

    for(let gh = 0; gh < hClv.length; gh++){
    if( arr[8 -(hClv[gh])[1]*1][xarr.indexOf((hClv[gh])[0])].id[3] == ochi2){arr[8 -(hClv[gh])[1]*1][xarr.indexOf((hClv[gh])[0])].style.outline = '0.4vw solid purple'}else{arr[8 -(hClv[gh])[1]*1][xarr.indexOf((hClv[gh])[0])].style.outline = '0.4vw solid blue'}
